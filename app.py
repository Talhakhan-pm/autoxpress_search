...
# Import and register Dialpad routes blueprint
from dialpad_routes import dialpad_routes, init_api
app.register_blueprint(dialpad_routes)

# Initialize Dialpad API
dialpad_api = init_api()
